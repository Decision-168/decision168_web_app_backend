...
const generatePortfolioRequestEmailTemplate = (
  pownerFName,
  PortfolioName,
  AboutPortfolio,
  acceptRequest,
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        Hello,<br><br>
                                            ${pownerFName} has invited you to join ${PortfolioName} portfolio as a team member. Just click the appropriate button below to join the portfolio or request more information.
                                            <br><br>
                                            Portfolio Short Description: ${AboutPortfolio}...
                                            <br><br>
                                        </p>
                                        <a href=${acceptRequest} style="background:#c7df19;text-decoration:none !important; font-weight:600; margin:20px; color:#fff;border:4px solid #c7df19;text-transform:uppercase; font-size:15px;padding:10px 30px;display:inline-block;border-radius:10px;">Join The Team</a>
                                        <a href=${rejectRequest} style="text-decoration:none !important; font-weight:600; margin:20px; color:#c7df19;border:4px solid #c7df19;text-transform:uppercase; font-size:15px;padding:10px 30px;display:inline-block;border-radius:10px;">Deny Request</a> 
                                            <br><br>
                                            <p style="color:#fff; font-size:15px;line-height:24px;text-align:left; margin:0;">
...
module.exports = generatePortfolioRequestEmailTemplate;
