...
const generatePaymentSuccessEmailTemplate = (
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#c7df19; font-weight:600; margin:0;font-size:33px;font-family:Rubik,sans-serif;">Payment Successful</h1>
                                            <span
...
module.exports = generatePaymentSuccessEmailTemplate;
