...
const generateCompanyPackageUpgradeEmailTemplate = (
    userFName,
    emsg
) => {
  return `
    ...
    <head>
      ...
      <title>Company Package Upgrade</title>
      <meta name="description" content="Company Package Upgrade">
      <style type="text/css">
...
module.exports = generateCompanyPackageUpgradeEmailTemplate;
