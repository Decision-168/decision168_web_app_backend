...
const generateRefundInitiatedEmailTemplate = (
    userFname, pack_name, refund_amount
) => {
  return `
  <!doctype html>
    <html lang="en-US">
    ...
    <head>
        ...
        <title>Downgrade Successful & Refund Initiated</title>
        <meta name="description" content="Downgrade Successful & Refund Initiated">
        <style type="text/css">
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#c7df19; font-weight:600; margin:0;font-size:33px;font-family:Rubik,sans-serif;">Downgrade Successful & Refund Initiated</h1>
                                            <span
                                            ...
                                            You have successfully downgraded the ${pack_name} package ! Refund initiated and will credit in your account within 5 Working Days!
                                                <br><br>
...
module.exports = generateRefundInitiatedEmailTemplate;
