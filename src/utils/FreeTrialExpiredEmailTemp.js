...
const generateFreeTrialExpiredEmailTemplate = (
    userFname
) => {
  return `
  <!doctype html>
    ...
    <head>
        ...
        <meta name="description" content="Free Trial Expired">
        <style type="text/css">
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#c7df19; font-weight:600; margin:0;font-size:33px;font-family:Rubik,sans-serif;">Free Trial Expired</h1>
                                            <span
                                            ...
                                            Your free trial Expired and switch to Solo pack!
                                            <br><br>
                                            </p>
                                            <p style="color:#fff; font-size:15px;line-height:24px;text-align:left; margin:0;">
                                                Thanks,
...
module.exports = generateFreeTrialExpiredEmailTemplate;
