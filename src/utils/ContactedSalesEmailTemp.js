...
const generateContactedSalesEmailTemplate = (
  getfname,
  email_address,
  phone_number
) => {
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            ...
                                            Hello SuperAdmin,<br><br>
                                                ${getfname} has contacted you regarding the package. Please find information below:
                                                <br><br>
                                                Name: ${getfname}
                                                <br><br>
                                                Email: ${email_address}
...
module.exports = generateContactedSalesEmailTemplate;
