...
const generateAutoRenewSubscriptionEmailTemplate = (
    userFname, pack_name, paidAmount, pack_price, sub_start, sub_end
) => {
  return `
  <!doctype html>
    <html lang="en-US">
    ...
    <head>
        ...
        <title>Auto Renew Subscription Successful</title>
        <meta name="description" content="Auto Renew Subscription Successful">
        <style type="text/css">
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#c7df19; font-weight:600; margin:0;font-size:33px;font-family:Rubik,sans-serif;">Auto Renew Subscription Successful</h1>
                                            <span
                                            ...
                                            Hello ${userFname},<br><br>
                                                Your auto renew subscription for ${pack_name} package was successful. Please find details below:
                                                <br><br>
...
module.exports = generateAutoRenewSubscriptionEmailTemplate;
