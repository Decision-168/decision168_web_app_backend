...
const generateAccountVerificationEmailTemplate = (
  full_name,
  verificationLink
) => {
  return `
                              ...
                              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                  ...
                                  <tr>
                                      <td style="padding:0 35px;">
                                          ...
                                          <a href=${verificationLink} style="background:#c7df19;text-decoration:none !important; font-weight:600; margin-top:35px; margin-bottom: 20px; color:#fff;text-transform:uppercase; font-size:15px;padding:10px 30px;display:inline-block;border-radius:10px;">Verify Your Account</a>
                                              <br><br>
                                              <p style="color:#fff; font-size:15px;line-height:24px;text-align:center; margin:0;">
                                              If that doesn\'t work, copy and paste the following link in your browser:
                                              <br>
                                              <a onMouseOver="this.style.pointer=cursor" href=${verificationLink} style="color:#c7df19;text-decoration: none;">${verificationLink}</a>
                                              </p>
                                              <br><br>
                                              <p style="color:#fff; font-size:15px;line-height:24px;text-align:left; margin:0;">
...
module.exports = generateAccountVerificationEmailTemplate;
