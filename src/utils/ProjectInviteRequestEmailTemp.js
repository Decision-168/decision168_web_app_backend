...
const generateProjectInviteRequestEmailTemplate = (
  pownerFName,
  pname,
  PortfolioName,
  short_pdes,
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        Hello,<br><br>
                                            ${pownerFName} has requested you to join project ${pname} as a ${position}. Just click the appropriate button below to join the project or request more information.
                                            <br><br>
                                            Portfolio: ${PortfolioName}
                                            <br><br>
                                            Project Short Description: ${short_pdes}...
                                            <br><br>
                                        </p>
                                        <a href=${acceptRequest} style="background:#c7df19;text-decoration:none !important; font-weight:600; margin:20px; color:#fff;border:4px solid #c7df19;text-transform:uppercase; font-size:15px;padding:10px 30px;display:inline-block;border-radius:10px;">Join Project</a>
...
module.exports = generateProjectInviteRequestEmailTemplate;
